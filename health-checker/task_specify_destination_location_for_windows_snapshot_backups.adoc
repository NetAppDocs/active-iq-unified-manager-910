...
. Exit the maintenance console and launch the Active IQ Unified Manager interface to create the Snapshot copy schedule if you have not already done this.
